export declare enum emberLifecycleHooks {
    INIT = "init",
...
export declare enum emberComponentProps {
...
export declare enum emberObjectTypes {
    COMPONENT = "Component",
    SERVIICE = "Service"
}
export declare enum emberMultiLineObjectMethods {
    COMPUTED = "computed",
    FILTER = "filter",
    FILTER_BY = "filterBy",
    MAP = "map",
...
export declare enum emberSingleLineObjectMethods {
    OR = "or",
    AND = "and",
    NOT = "not",
    ALIAS = "alias",
